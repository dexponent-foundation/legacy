...
const provider = new ethers.JsonRpcProvider('https://optimism-goerli.infura.io/v3/2dff452478174fdf8035dc20eadb5667');

// Your contract's address and ABI (Application Binary Interface)
const contractAddress = '0x111BAbcdd66b1B60A20152a2D3D06d36F8B5703c';
const contractABI = 
    [
        {
            "anonymous": false,
...
// Create a wallet (you can use a private key or a mnemonic phrase)
const privateKey = 'e00a4371afd545c0c171cb2898983e7a3daa3bf3697b8e894535ce411b714545';
const wallet = new ethers.Wallet(privateKey, provider);

// Connect to the contract using its address and ABI
const contract = new ethers.Contract(contractAddress, contractABI, wallet);

// // Call a function on the contract (e.g., a read-only function)
// async function readContract() {
//   const result = await contract.someFunction(); // Replace with your contract function
//   console.log('Contract result:', result);
// }

// Send a transaction to the contract (e.g., a write function)
async function sendTransaction() {
  let tx = await contract.delayedOrders(wallet.address); // Replace with your contract function
  ...
  const connection = new EvmPriceServiceConnection(
       ...
       let priceUpdateData = await connection.getPriceFeedsUpdateData(priceIds);
        ...
        tx = contract.assetPrice()
        console.log(tx[0])
       tx = await contract.submitOffchainDelayedOrder(ethers.parseEther("0.02"),'1634863000000000000000')
       tx.wait();
       console.log(tx)
     tx = await contract.delayedOrders(wallet.address);
    console.log(tx)
       tx = await contract.executeOffchainDelayedOrder(wallet.address,priceUpdateData,{value:ethers.parseEther("0.00000000000000001")})
       tx.wait();
       console.log(tx)
    }
// Call your functions
